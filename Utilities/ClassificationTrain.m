...
elseif numel(unique(Class)) == 2 && ismember(Method,{'AdaBoostM2'})
    error("The data is a 2-class classification problem. 'AdaBoostM2' cannot be used as a method for this data.")

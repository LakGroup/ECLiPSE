function PLSmodel = bipls_sub_pls_val(X,Y,no_of_lv,prepro_method,val_method,segments);
...
switch val_method
    case 'test'
      ...
      [P,Q,W,T,U,bsco,ssqdif]=bipls_sub_pls(Xseg,Yseg,no_of_lv);
      Ypred(segments,:,:)=bipls_sub_pls_pre(Xpseg,bsco,P,Q,W,no_of_lv);
      for j=1:no_of_lv
	...
	for i=1:segments
        ...
        if strcmp(val_method,'syst111')
         ...
         [P,Q,W,T,U,bsco,ssqdif] = bipls_sub_pls(Xseg,Yseg,no_of_lv);
         Ypred(p_cvs,:,:) = bipls_sub_pls_pre(Xpseg,bsco,P,Q,W,no_of_lv);
         for j=1:no_of_lv
...
[PLSmodel.P,PLSmodel.Q,PLSmodel.W,PLSmodel.T,PLSmodel.U,PLSmodel.bsco,PLSmodel.ssqdif] = bipls_sub_pls(X,Y,no_of_lv);
